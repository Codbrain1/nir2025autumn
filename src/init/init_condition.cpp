...
namespace InitialConditoin
{
    ...
    void set_exponential_disk(ParticleContainer<double>& ps,double solt,double R)
    {
        
    }
   inline void set_circle_velocity(ParticleContainer<double>& ps,double M,double R)
    {
    ...
    void set_exponential_disk(ParticleContainer<long double>& ps,long double solt, long double R)
    {

    }
    inline void set_circle_velocity(ParticleContainer<long double>& ps,long double M,long double R)
    {
        for(int i=0;i<ps.N;++i)
        {
